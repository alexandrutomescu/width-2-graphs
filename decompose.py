...
requiredNamed.add_argument('-m', '--max', type=int, help='max value of a path weight', required=True)
...
if __name__ == '__main__':
    ...
    results = []
    for firstWeight in range(0, T):
        result = pool.apply_async(solveGreedyWithFirstWeight, (firstWeight, k, T))
